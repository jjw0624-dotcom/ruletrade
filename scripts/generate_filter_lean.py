...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate the Filter screening LEAN algorithm")
    parser.add_argument("--output", type=Path, default=Path("build/lean/filter/Main.cs"))
