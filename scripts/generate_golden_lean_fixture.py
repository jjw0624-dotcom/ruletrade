...
# Full-day NASDAQ closures during the Golden 2024 backtest. Early closes remain
...
def trading_dates_2024() -> tuple[date, ...]:
...
def daily_rows(symbol: str) -> str:
    ...
    rows = []
    for index, trading_date in enumerate(trading_dates_2024()):
        close = initial_close + daily_step * index
        rows.append(
