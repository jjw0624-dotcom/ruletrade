...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate the Fallback LEAN algorithm")
    parser.add_argument("--output", type=Path, default=Path("build/lean/fallback/Main.cs"))
