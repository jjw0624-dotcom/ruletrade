...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate the Independent Schedules LEAN algorithm")
    parser.add_argument(
        "--output", type=Path, default=Path("build/lean/independent-schedules/Main.cs")
    )
