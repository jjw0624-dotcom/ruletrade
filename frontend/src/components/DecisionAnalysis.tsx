...
export function DecisionAnalysis({ runId, sessions, listState, selected, selectedAsset, onSelect, onSelectAsset, onShowInStrategy, onViewInFlow, onComparisonReady }: { runId: string; sessions: DecisionSession[]; listState: "loading" | "loaded" | "error"; selected: DecisionSession | null; selectedAsset?: string | null; onSelect: (session: DecisionSession) => void; onSelectAsset?: (asset: string) => void; onShowInStrategy?: ShowRule; onViewInFlow?: ShowRule; onComparisonReady?: (comparison: ComparisonRecord, context: ResearchContext) => void }) {
